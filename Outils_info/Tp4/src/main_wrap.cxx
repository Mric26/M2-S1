...
#define SWIG_init    Mymodule_Init
#define SWIG_name    "mymodule"
#define SWIG_prefix  ""
...
extern "C" {
#endif
SWIGINTERN const char *_wrap_PI_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_double(static_cast< double >(PI));
  if (value) {
...
SWIGINTERN int
_wrap_pi(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double result;
  
  if (SWIG_GetArgs(interp, objc, objv,":pi ") == TCL_ERROR) SWIG_fail;
  result = (double)pi();
...
SWIGINTERN int
_wrap_add_pi(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  double result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:add_pi v ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_set_log(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:set_log v ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_stats(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":stats ") == TCL_ERROR) SWIG_fail;
  stats();
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "pi", (swig_wrapper_func) _wrap_pi, NULL},
    { SWIG_prefix "add_pi", (swig_wrapper_func) _wrap_add_pi, NULL},
    { SWIG_prefix "set_log", (swig_wrapper_func) _wrap_set_log, NULL},
    { SWIG_prefix "stats", (swig_wrapper_func) _wrap_stats, NULL},
    {0, 0, 0}
};

static swig_var_info swig_variables[] = {
    { SWIG_prefix "PI", 0, (swig_variable_func) _wrap_PI_get,(swig_variable_func) swig_readonly},
    {0,0,0,0}
};
...
SWIGEXPORT int Mymodule_SafeInit(Tcl_Interp *interp) {
