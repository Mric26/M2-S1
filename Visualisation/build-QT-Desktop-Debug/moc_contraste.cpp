...
struct qt_meta_stringdata_Contraste_t {
    QByteArrayData data[4];
    char stringdata[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Contraste_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Contraste_t qt_meta_stringdata_Contraste = {
    {
...
QT_MOC_LITERAL(3, 19, 7)
    ...
    "Contraste\0valider\0\0annuler\0"
};
...
const QMetaObject Contraste::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Contraste.data,
      qt_meta_data_Contraste,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Contraste.stringdata))
